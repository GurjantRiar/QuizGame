...
function init() {
  ...
  heading.textContent =
    "This game gives you the opportunity to take a time quiz!";

  // creates elements with the instructions for the game
  let instructions = document.createElement("p");
  instructions.setAttribute("id", "instructions");
  instructions.textContent =
    " You will have 5 seconds to answer each question. If you answer correctly you will score points. The quicker you answer the more points you will score. If you score incorrectly you will not lose points, but you will be penalized time.";
...
function endOfGame() {
  ...
  initialsInput.addEventListener("input", function () {
    ...
    if (initialsInput.value.length === 3) {
      ...
      let thisScore = [
        { type: quizType, name: initialsInput.value, score: score },
      ];
